...
function do_html_header($title){
	$base="https://www.cloudsgreen.com";
	?>
<!DOCTYPE html>
...
<div id="responsive_part">
  <div class="logo"> <a href="index.php"><span>Cloudsgreen</span><span class="icon"></span></a> </div>
  ...
  <div class="viewport ">
    <div class="overview collapse">
      <div class="search row-fluid container">
        ...
        <form class="form-search" action="search.php" method="get">
          <div class="input-append">
            <input type="text" name="query" class=" search-query" placeholder="">
     ...
     <ul id="sidebar_menu"  class="navbar nav nav-list container full">
            ...
            <li class="color_4"> <a class="dashboard " href="index.php"><img src="img/menu_icons/home.png"><span>Dashboard</span></a> </li>
            <li class="color_13"> <a class="dashboard " href="inventory.php"><img src="img/menu_icons/others.png"><span>Inventory</span></a> </li>
           </ul>
<!--
      ...
      <div class="top_right">
        <ul class="nav nav_menu">
          <li class="dropdown"> <a class="dropdown-toggle administrator" id="dLabel" role="button" data-toggle="dropdown" data-target="#" href="/page.html">
            <div class="title"><span class="name"><?php if(isset($_SESSION['name']))echo $_SESSION['name']; ?></span><span class="subtitle"></span></div>
            <span class="icon"><img src="strfiles/<?php if(isset($_SESSION['comp_id'])) echo $_SESSION['comp_id'].'.jpg'; ?>" width=96px height=96px></span></a>
